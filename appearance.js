...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Bot Whatsapp 𝔊𝔯𝔢𝔤𝔬𝔯𝔦𝔲𝔰-𝔅𝔬𝔱`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;HardzBot,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
{text: tek,
buttons: btn_menu})
Biiofc.sendMessage(`${'895388290404@s.whatsapp.net'}`, {text: `*👋HALLO OWNER KU, ADA YANG ORDER NIH*\n\n*DARI* : ${sender.split('@')[0]}`})
}
